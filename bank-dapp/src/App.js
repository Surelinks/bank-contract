...
function App() {
  ...
  const contractAddress = '0x1231ff0afA29f01601fc7E1C1FED66706038EaeB';
  ...
  const getBankName = async () => {
    try {
      if (window.ethereum) {
        ...
        console.log("Ethereum object not found, install metamamsk");
  ...
  const withDrawMoneyHandler = async (event) => {
    try {
      if (window.ethereum) {
        ...
        console.log("proder signer...", myAddress);
        ...
        console.log("Ethereum Object not found, Install metamask");
        setError("Please install a metamask to use our bank");
      }
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <main className="main-container">
      <h2 className="headline"><span className="headline-gradient">Bank Contract Project by Links</span> 💰</h2>
